...
#define USBD_MANUFACTURER_STRING "Raretem"
#define USBD_PID_FS 22315
#define USBD_PRODUCT_STRING_FS "Raretem USB keypad"
...
static void Get_SerialNum(void)
{
	...
	*_*/
	...
	extern	uint32_t	sysID;	///	defined in main.c

	uint32_t	i, j, ser = sysID;

	for (i = 1000000000, j = 2; i; i /= 10)
	{
		if (i == 10000)
		{
			USBD_StringSerial[j++] = '_';
			USBD_StringSerial[j++] = 0;
		}
		USBD_StringSerial[j++] = (ser / i) + '0';
		USBD_StringSerial[j++] = 0;
		ser %= i;
	}
}
