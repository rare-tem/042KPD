...
#define LL_SYSCFG_IR_MOD_TIM16                                                                                         \
	(SYSCFG_CFGR1_IR_MOD_0 & SYSCFG_CFGR1_IR_MOD_1)		/*!< Timer16 is selected as IR Modulation envelope source */
...
#define LL_SYSCFG_USART2_RMP_DMA1CH54                                                                                  \
	((SYSCFG_CFGR1_USART2_DMA_RMP >> 8U) |                                                                             \
	 (uint32_t)0x00000000U) /*!< USART2_RX and USART2_TX DMA requests mapped on DMA channel 5 and 4U respectively */
#define LL_SYSCFG_USART2_RMP_DMA1CH67                                                                                  \
	((SYSCFG_CFGR1_USART2_DMA_RMP >> 8U) |                                                                             \
	 SYSCFG_CFGR1_USART2_DMA_RMP) /*!< USART2_RX and USART2_TX DMA requests mapped on DMA channel 6 and 7 respectively \
								   */
...
#define LL_SYSCFG_USART3_RMP_DMA1CH67                                                                                  \
	((SYSCFG_CFGR1_USART3_DMA_RMP >> 8U) |                                                                             \
	 (uint32_t)0x00000000U) /*!< USART3_RX and USART3_TX DMA requests mapped on DMA channel 6 and 7 respectively */
#define LL_SYSCFG_USART3_RMP_DMA1CH32                                                                                  \
	((SYSCFG_CFGR1_USART3_DMA_RMP >> 8U) |                                                                             \
	 SYSCFG_CFGR1_USART3_DMA_RMP) /*!< USART3_RX and USART3_TX DMA requests mapped on DMA channel 3U and 2U            \
									 respectively */
#endif							  /* SYSCFG_CFGR1_USART3_DMA_RMP */
/**
 * @}
 */
#endif /* SYSCFG_CFGR1_USART1TX_DMA_RMP || SYSCFG_CFGR1_USART1RX_DMA_RMP || SYSCFG_CFGR1_USART2_DMA_RMP ||             \
...
#define LL_SYSCFG_SPI2_RMP_DMA1_CH45                                                                                   \
	(uint32_t)0x00000000U /*!< SPI2_RX and SPI2_TX DMA requests mapped on DMA channel 4U and 5 respectively */
#define LL_SYSCFG_SPI2_RMP_DMA1_CH67                                                                                   \
	SYSCFG_CFGR1_SPI2_DMA_RMP /*!< SPI2_RX and SPI2_TX DMA requests mapped on DMA channel 6 and 7 respectively */
	/**
	 * @}
	 */
...
#define LL_SYSCFG_I2C1_RMP_DMA1_CH32                                                                                   \
	(uint32_t)0x00000000U /*!< I2C1_RX and I2C1_TX DMA requests mapped on DMA channel 3U and 2U respectively */
#define LL_SYSCFG_I2C1_RMP_DMA1_CH76                                                                                   \
	SYSCFG_CFGR1_I2C1_DMA_RMP /*!< I2C1_RX and I2C1_TX DMA requests mapped on DMA channel 7 and 6 respectively */
	/**
	 * @}
	 */
...
#define LL_SYSCFG_ADC1_RMP_DMA1_CH2 SYSCFG_CFGR1_ADC_DMA_RMP /*!< ADC DMA request mapped on DMA channel 2U */
	...
	defined(SYSCFG_CFGR1_TIM1_DMA_RMP) || defined(SYSCFG_CFGR1_TIM2_DMA_RMP) || defined(SYSCFG_CFGR1_TIM3_DMA_RMP)
...
#define LL_SYSCFG_TIM16_RMP_DMA1_CH3                                                                                   \
	(((SYSCFG_CFGR1_TIM16_DMA_RMP | SYSCFG_CFGR1_TIM16_DMA_RMP2) >> 8U) |                                              \
	 (uint32_t)0x00000000U) /*!< TIM16_CH1 and TIM16_UP DMA requests mapped on DMA channel 3 */
#define LL_SYSCFG_TIM16_RMP_DMA1_CH4                                                                                   \
	(((SYSCFG_CFGR1_TIM16_DMA_RMP | SYSCFG_CFGR1_TIM16_DMA_RMP2) >> 8U) |                                              \
	 SYSCFG_CFGR1_TIM16_DMA_RMP) /*!< TIM16_CH1 and TIM16_UP DMA requests mapped on DMA channel 4 */
#define LL_SYSCFG_TIM16_RMP_DMA1_CH6                                                                                   \
	((SYSCFG_CFGR1_TIM16_DMA_RMP2 >> 8U) |                                                                             \
	 SYSCFG_CFGR1_TIM16_DMA_RMP2) /*!< TIM16_CH1 and TIM16_UP DMA requests mapped on DMA channel 6 */
#else
#define LL_SYSCFG_TIM16_RMP_DMA1_CH3                                                                                   \
...
#define LL_SYSCFG_TIM17_RMP_DMA1_CH1                                                                                   \
	(((SYSCFG_CFGR1_TIM17_DMA_RMP | SYSCFG_CFGR1_TIM17_DMA_RMP2) >> 8U) |                                              \
	 (uint32_t)0x00000000U) /*!< TIM17_CH1 and TIM17_UP DMA requests mapped on DMA channel 1 */
#define LL_SYSCFG_TIM17_RMP_DMA1_CH2                                                                                   \
	(((SYSCFG_CFGR1_TIM17_DMA_RMP | SYSCFG_CFGR1_TIM17_DMA_RMP2) >> 8U) |                                              \
	 SYSCFG_CFGR1_TIM17_DMA_RMP) /*!< TIM17_CH1 and TIM17_UP DMA requests mapped on DMA channel 2 */
#define LL_SYSCFG_TIM17_RMP_DMA1_CH7                                                                                   \
	((SYSCFG_CFGR1_TIM17_DMA_RMP2 >> 8U) |                                                                             \
	 SYSCFG_CFGR1_TIM17_DMA_RMP2) /*!< TIM17_CH1 and TIM17_UP DMA requests mapped on DMA channel 7 */
#else
#define LL_SYSCFG_TIM17_RMP_DMA1_CH1                                                                                   \
...
#define LL_SYSCFG_TIM1_RMP_DMA1_CH234                                                                                  \
	((SYSCFG_CFGR1_TIM1_DMA_RMP >> 8U) | (uint32_t)0x00000000U) /*!< TIM1_CH1, TIM1_CH2 and TIM1_CH3 DMA requests      \
																   mapped on DMAchannel 2, 3 and 4 respectively */
#define LL_SYSCFG_TIM1_RMP_DMA1_CH6                                                                                    \
	((SYSCFG_CFGR1_TIM1_DMA_RMP >> 8U) |                                                                               \
	 SYSCFG_CFGR1_TIM1_DMA_RMP) /*!< TIM1_CH1, TIM1_CH2 and TIM1_CH3 DMA requests mapped on DMA channel 6 */
...
#define LL_SYSCFG_TIM2_RMP_DMA1_CH34                                                                                   \
	((SYSCFG_CFGR1_TIM2_DMA_RMP >> 8U) |                                                                               \
	 (uint32_t)0x00000000U) /*!< TIM2_CH2 and TIM2_CH4 DMA requests mapped on DMA channel 3 and 4 respectively */
#define LL_SYSCFG_TIM2_RMP_DMA1_CH7                                                                                    \
	((SYSCFG_CFGR1_TIM2_DMA_RMP >> 8U) |                                                                               \
	 SYSCFG_CFGR1_TIM2_DMA_RMP) /*!< TIM2_CH2 and TIM2_CH4 DMA requests mapped on DMA channel 7 */
...
#define LL_SYSCFG_TIM3_RMP_DMA1_CH4                                                                                    \
	((SYSCFG_CFGR1_TIM3_DMA_RMP >> 8U) |                                                                               \
	 (uint32_t)0x00000000U) /*!< TIM3_CH1 and TIM3_TRIG DMA requests mapped on DMA channel 4 */
#define LL_SYSCFG_TIM3_RMP_DMA1_CH6                                                                                    \
	((SYSCFG_CFGR1_TIM3_DMA_RMP >> 8U) |                                                                               \
	 SYSCFG_CFGR1_TIM3_DMA_RMP) /*!< TIM3_CH1 and TIM3_TRIG DMA requests mapped on DMA channel 6 */
#endif							/*SYSCFG_CFGR1_TIM3_DMA_RMP*/
	/**
	 * @}
	 */

#endif /* SYSCFG_CFGR1_TIM16_DMA_RMP || SYSCFG_CFGR1_TIM17_DMA_RMP || SYSCFG_CFGR1_TIM1_DMA_RMP ||                     \
		  SYSCFG_CFGR1_TIM2_DMA_RMP || SYSCFG_CFGR1_TIM3_DMA_RMP */
...
#define LL_FLASH_LATENCY_1 FLASH_ACR_LATENCY /*!< FLASH One Latency cycle */
	...
	{
		return (uint32_t)(READ_BIT(SYSCFG->EXTICR[Line & 0xFF], (SYSCFG_EXTICR1_EXTI0 << (Line >> 16))) >>
						  (Line >> 16));
	}
	...
	{
#if defined(SYSCFG_CFGR2_PVD_LOCK)
		MODIFY_REG(SYSCFG->CFGR2, SYSCFG_CFGR2_LOCKUP_LOCK | SYSCFG_CFGR2_SRAM_PARITY_LOCK | SYSCFG_CFGR2_PVD_LOCK,
				   Break);
#else
