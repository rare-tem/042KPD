...
#define EXTI_LINE_23                                                                                                   \
	(EXTI_DIRECT | 0x17u) /*!< External interrupt line 23 Connected to the internal I2C1 wakeup event  */
#else
...
#define EXTI_LINE_25                                                                                                   \
	(EXTI_CONFIG | 0x19u) /*!< External interrupt line 25 Connected to the internal USART1 wakeup event  */
#else
...
#define EXTI_LINE_26                                                                                                   \
	(EXTI_CONFIG | 0x1Au) /*!< External interrupt line 26 Connected to the internal USART2 wakeup event  */
#else
...
#define EXTI_LINE_27                                                                                                   \
	(EXTI_CONFIG | 0x1Bu) /*!< External interrupt line 27 Connected to the internal CEC wakeup event  */
#else
...
#define EXTI_LINE_28                                                                                                   \
	(EXTI_CONFIG | 0x1Cu) /*!< External interrupt line 28 Connected to the  internal USART3 wakeup event   */
#else
...
#define EXTI_LINE_31                                                                                                   \
	(EXTI_CONFIG | 0x1Fu) /*!< External interrupt line 31 Connected to the VDDIO2 supply comparator output  */
#else
