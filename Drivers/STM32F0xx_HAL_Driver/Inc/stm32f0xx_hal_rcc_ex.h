...
#define IS_RCC_SYSCLKSOURCE_STATUS(SOURCE)                                                                             \
	(((SOURCE) == RCC_SYSCLKSOURCE_STATUS_HSI) || ((SOURCE) == RCC_SYSCLKSOURCE_STATUS_HSE) ||                         \
	 ((SOURCE) == RCC_SYSCLKSOURCE_STATUS_PLLCLK) || ((SOURCE) == RCC_SYSCLKSOURCE_STATUS_HSI48))

#define IS_RCC_PLLSOURCE(SOURCE)                                                                                       \
	(((SOURCE) == RCC_PLLSOURCE_HSI) || ((SOURCE) == RCC_PLLSOURCE_HSI48) || ((SOURCE) == RCC_PLLSOURCE_HSE))
...
#define IS_RCC_MCO1SOURCE(SOURCE)                                                                                      \
	(((SOURCE) == RCC_MCO1SOURCE_NOCLOCK) || ((SOURCE) == RCC_MCO1SOURCE_LSI) || ((SOURCE) == RCC_MCO1SOURCE_LSE) ||   \
	 ((SOURCE) == RCC_MCO1SOURCE_SYSCLK) || ((SOURCE) == RCC_MCO1SOURCE_HSI) || ((SOURCE) == RCC_MCO1SOURCE_HSE) ||    \
...
#define IS_RCC_PERIPHCLOCK(SELECTION) ((SELECTION) <= (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_RTC))
...
#define IS_RCC_PERIPHCLOCK(SELECTION)                                                                                  \
	((SELECTION) <= (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_USB))
...
#define IS_RCC_PERIPHCLOCK(SELECTION)                                                                                  \
	((SELECTION) <=                                                                                                    \
	 (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_CEC | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_USB))
#endif /* STM32F042x6 || STM32F048xx */

#if defined(STM32F051x8) || defined(STM32F058xx)

#define IS_RCC_PERIPHCLOCK(SELECTION)                                                                                  \
	((SELECTION) <= (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_CEC | RCC_PERIPHCLK_RTC))
...
#define IS_RCC_PERIPHCLOCK(SELECTION)                                                                                  \
	((SELECTION) <=                                                                                                    \
	 (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_CEC | RCC_PERIPHCLK_RTC))
#endif /* STM32F071xB */

#if defined(STM32F072xB) || defined(STM32F078xx)

#define IS_RCC_PERIPHCLOCK(SELECTION)                                                                                  \
	((SELECTION) <= (RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_CEC |            \
...
#define IS_RCC_USBCLKSOURCE(SOURCE) (((SOURCE) == RCC_USBCLKSOURCE_NONE) || ((SOURCE) == RCC_USBCLKSOURCE_PLL))
...
#define IS_RCC_MCODIV(DIV)                                                                                             \
	(((DIV) == RCC_MCODIV_1) || ((DIV) == RCC_MCODIV_2) || ((DIV) == RCC_MCODIV_4) || ((DIV) == RCC_MCODIV_8) ||       \
	 ((DIV) == RCC_MCODIV_16) || ((DIV) == RCC_MCODIV_32) || ((DIV) == RCC_MCODIV_64) || ((DIV) == RCC_MCODIV_128))
#else
...
#define IS_RCC_CRS_SYNC_SOURCE(_SOURCE_)                                                                               \
	(((_SOURCE_) == RCC_CRS_SYNC_SOURCE_GPIO) || ((_SOURCE_) == RCC_CRS_SYNC_SOURCE_LSE) ||                            \
	 ((_SOURCE_) == RCC_CRS_SYNC_SOURCE_USB))
#define IS_RCC_CRS_SYNC_DIV(_DIV_)                                                                                     \
	(((_DIV_) == RCC_CRS_SYNC_DIV1) || ((_DIV_) == RCC_CRS_SYNC_DIV2) || ((_DIV_) == RCC_CRS_SYNC_DIV4) ||             \
	 ((_DIV_) == RCC_CRS_SYNC_DIV8) || ((_DIV_) == RCC_CRS_SYNC_DIV16) || ((_DIV_) == RCC_CRS_SYNC_DIV32) ||           \
	 ((_DIV_) == RCC_CRS_SYNC_DIV64) || ((_DIV_) == RCC_CRS_SYNC_DIV128))
#define IS_RCC_CRS_SYNC_POLARITY(_POLARITY_)                                                                           \
	(((_POLARITY_) == RCC_CRS_SYNC_POLARITY_RISING) || ((_POLARITY_) == RCC_CRS_SYNC_POLARITY_FALLING))
 ...
 */
	...
	typedef struct
	{
		...
		uint32_t ReloadValue; /*!< Specifies the value to be loaded in the frequency error counter with each SYNC event.
								  It can be calculated in using macro @ref
								 __HAL_RCC_CRS_RELOADVALUE_CALCULATE(__FTARGET__, __FSYNC__) This parameter must be a
								 number between 0 and 0xFFFF or a value of @ref RCCEx_CRS_ReloadValueDefault .*/
		...
		uint32_t HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value to the HSI48 oscillator.
										   This parameter must be a number between 0 and 0x3F or a value of @ref
	...
	typedef struct
	{
		...
		uint32_t FreqErrorDirection; /*!< Specifies the value loaded in the .FEDIR, the counting direction of the
																	   frequency error counter latched in the time of
									   the last SYNC event. It shows whether the actual frequency is below or above the
									   target. This parameter must be a value of @ref RCCEx_CRS_FreqErrorDirection*/
...
#define RCC_CRS_RELOADVALUE_DEFAULT                                                                                    \
	(0x0000BB7FU) /*!< The reset value of the RELOAD field corresponds                                                 \
								 to a target frequency of 48 MHz and a synchronization signal frequency of 1 kHz (SOF  \
					 signal from USB). */
/**
 * @}
 */
 ...
 */
	...
	defined(STM32F078xx) || defined(STM32F070xB) || defined(STM32F091xC) || defined(STM32F098xx) ||                    \
	defined(STM32F030xC)
...
#if defined(STM32F030x8) || defined(STM32F042x6) || defined(STM32F048xx) || defined(STM32F051x8) ||                    \
...
#if defined(STM32F030x8) || defined(STM32F051x8) || defined(STM32F058xx) || defined(STM32F071xB) ||                    \
...
#if defined(STM32F042x6) || defined(STM32F048xx) || defined(STM32F070x6) || defined(STM32F072xB) ||                    \
	defined(STM32F078xx) || defined(STM32F070xB)
