...
#define IS_RCC_HSI14(__HSI14__)                                                                                        \
	(((__HSI14__) == RCC_HSI14_OFF) || ((__HSI14__) == RCC_HSI14_ON) || ((__HSI14__) == RCC_HSI14_ADC_CONTROL))
...
#define IS_RCC_PREDIV(__PREDIV__)                                                                                      \
	(((__PREDIV__) == RCC_PREDIV_DIV1) || ((__PREDIV__) == RCC_PREDIV_DIV2) || ((__PREDIV__) == RCC_PREDIV_DIV3) ||    \
	 ((__PREDIV__) == RCC_PREDIV_DIV4) || ((__PREDIV__) == RCC_PREDIV_DIV5) || ((__PREDIV__) == RCC_PREDIV_DIV6) ||    \
	 ((__PREDIV__) == RCC_PREDIV_DIV7) || ((__PREDIV__) == RCC_PREDIV_DIV8) || ((__PREDIV__) == RCC_PREDIV_DIV9) ||    \
	 ((__PREDIV__) == RCC_PREDIV_DIV10) || ((__PREDIV__) == RCC_PREDIV_DIV11) || ((__PREDIV__) == RCC_PREDIV_DIV12) || \
	 ((__PREDIV__) == RCC_PREDIV_DIV13) || ((__PREDIV__) == RCC_PREDIV_DIV14) || ((__PREDIV__) == RCC_PREDIV_DIV15) || \
...
#define IS_RCC_I2C1CLKSOURCE(__SOURCE__)                                                                               \
	(((__SOURCE__) == RCC_I2C1CLKSOURCE_HSI) || ((__SOURCE__) == RCC_I2C1CLKSOURCE_SYSCLK))
	...
	typedef struct
	{
		...
		uint32_t
			HSI14CalibrationValue; /*!< The HSI14 calibration trimming value (default is RCC_HSI14CALIBRATION_DEFAULT).
										This parameter must be a number between Min_Data = 0x00 and Max_Data = 0x1FU */
...
#define RCC_FLAG_IWDGRST                                                                                               \
	((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_IWDGRSTF_BitNumber)) /*!< Independent Watchdog reset flag */
#define RCC_FLAG_WWDGRST                                                                                               \
	((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_WWDGRSTF_BitNumber)) /*!< Window watchdog reset flag */
#define RCC_FLAG_LPWRRST ((uint8_t)((CSR_REG_INDEX << 5U) | RCC_CSR_LPWRRSTF_BitNumber)) /*!< Low-Power reset flag */

/* Flags in the BDCR register */
#define RCC_FLAG_LSERDY                                                                                                \
	((uint8_t)((BDCR_REG_INDEX << 5U) | RCC_BDCR_LSERDY_BitNumber)) /*!< External Low Speed oscillator Ready */
