...
#define IS_LL_DMA_PERIPHREQUEST(__VALUE__)                                                                             \
	(((__VALUE__) == LL_DMA_REQUEST_0) || ((__VALUE__) == LL_DMA_REQUEST_1) || ((__VALUE__) == LL_DMA_REQUEST_2) ||    \
	 ((__VALUE__) == LL_DMA_REQUEST_3) || ((__VALUE__) == LL_DMA_REQUEST_4) || ((__VALUE__) == LL_DMA_REQUEST_5) ||    \
	 ((__VALUE__) == LL_DMA_REQUEST_6) || ((__VALUE__) == LL_DMA_REQUEST_7) || ((__VALUE__) == LL_DMA_REQUEST_8) ||    \
	 ((__VALUE__) == LL_DMA_REQUEST_9) || ((__VALUE__) == LL_DMA_REQUEST_10) || ((__VALUE__) == LL_DMA_REQUEST_11) ||  \
	 ((__VALUE__) == LL_DMA_REQUEST_12) || ((__VALUE__) == LL_DMA_REQUEST_13) || ((__VALUE__) == LL_DMA_REQUEST_14) || \
