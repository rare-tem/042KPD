...
#include <stdint.h>
	...
	typedef struct
	{
		...
		CAN_FilterRegister_TypeDef
			sFilterRegister[14]; /*!< CAN Filter Register,                 Address offset: 0x240-0x2AC   */
	} CAN_TypeDef;
...
#define DBGMCU_APB1_FZ_DBG_IWDG_STOP                                                                                   \
	DBGMCU_APB1_FZ_DBG_IWDG_STOP_Msk /*!< Debug Independent Watchdog stopped when Core is halted */
...
#define DBGMCU_APB1_FZ_DBG_I2C1_SMBUS_TIMEOUT                                                                          \
	DBGMCU_APB1_FZ_DBG_I2C1_SMBUS_TIMEOUT_Msk /*!< I2C1 SMBUS timeout mode stopped when Core is halted */
...
#define RCC_CFGR3_CECSW_HSI_DIV244                                                                                     \
	(0x00000000U) /*!< HSI clock divided by 244 selected as HDMI CEC entry clock source */
...
#define SYSCFG_CFGR1_PA11_PA12_RMP                                                                                     \
	SYSCFG_CFGR1_PA11_PA12_RMP_Msk /*!< PA11 and PA12 remap on QFN28 and TSSOP20 packages */
...
#define SYSCFG_CFGR2_SRAM_PARITY_LOCK                                                                                  \
	SYSCFG_CFGR2_SRAM_PARITY_LOCK_Msk /*!< Enables and locks the SRAM_PARITY error signal with Break Input of TIMER1   \
									   */
...
#define SYSCFG_CFGR2_PVD_LOCK                                                                                          \
	SYSCFG_CFGR2_PVD_LOCK_Msk /*!< Enables and locks the PVD connection with Timer1 Break Input and also the PVD_EN    \
								 and PVDSEL[2:0] bits of the Power Control Interface */
...
#define IS_GPIO_ALL_INSTANCE(INSTANCE)                                                                                 \
	(((INSTANCE) == GPIOA) || ((INSTANCE) == GPIOB) || ((INSTANCE) == GPIOC) || ((INSTANCE) == GPIOF))

/**************************** GPIO Alternate Function Instances ***************/
#define IS_GPIO_AF_INSTANCE(INSTANCE) (((INSTANCE) == GPIOA) || ((INSTANCE) == GPIOB) || ((INSTANCE) == GPIOF))
...
#define IS_TIM_CLOCK_SELECT_INSTANCE(INSTANCE) (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3))
...
#define IS_TIM_REMAP_INSTANCE(INSTANCE) (((INSTANCE) == TIM1) || ((INSTANCE) == TIM14))
...
#define IS_UART_DRIVER_ENABLE_INSTANCE(INSTANCE) (((INSTANCE) == USART1) || ((INSTANCE) == USART2))
