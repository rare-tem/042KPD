...
#ifndef	_oRIG_MOUSE_HId_	///
static uint8_t usbdHIDdataOut(USBD_HandleTypeDef *pdev, uint8_t epnum);
#endif	///	!_oRIG_MOUSE_HId_
...
#ifdef	_oRIG_MOUSE_HId_	///
	NULL,			 /*DataOut*/
#else	///	_oRIG_MOUSE_HId_
	usbdHIDdataOut,
#endif	///	_oRIG_MOUSE_HId_
	NULL,			 /*SOF */
	NULL,
...
#ifndef	_oRIG_MOUSE_HId_	///
extern	volatile	uint8_t 	lockLED;	///	defined in main.c
#endif	///	!_oRIG_MOUSE_HId_
...
#ifndef	_oRIG_MOUSE_HId_	///
	USBD_LL_PrepareReceive(pdev, HID_EPOUT_ADDR, (uint8_t *)&lockLED, HID_EPOUT_SIZE);
#endif	///	!_oRIG_MOUSE_HId_
